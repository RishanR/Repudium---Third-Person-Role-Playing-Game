...
namespace RPGCharacterAnims{
    ...
    public class RPGCharacterControllerFREE : MonoBehaviour{
        ...
        public float movementAnimationSpeed = 1;
					...
					if(!isBlocking){
                        ...
                        if (rpgCharacterInputController.inputAttackL)
                        {
                            if (rpgCharacterMovementController.isMoving)
                                rpgCharacterMovementController.isMoving = false;
                            Attack(1);
                            if (canDamage)
                                canExit = true;
                        }
                        ...
                        //Sprint
                        if (rpgCharacterInputController.inputSprint)
                        {
                            if (movementAnimationSpeed == 1)
                                movementAnimationSpeed = 1.5f;
                            else
		...
		void UpdateAnimationSpeed(){
            ...
            animator.SetFloat("MovementAnimationSpeed", movementAnimationSpeed);
		}
